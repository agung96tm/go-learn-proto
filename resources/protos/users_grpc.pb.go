...
func (c *usersClient) ListUser(ctx context.Context, in *ListUserIn, opts ...grpc.CallOption) (*ListUserOut, error) {
	out := new(ListUserOut)
...
func (UnimplementedUsersServer) ListUser(context.Context, *ListUserIn) (*ListUserOut, error) {
...
func _Users_ListUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServer).ListUser(ctx, req.(*ListUserIn))
	}
